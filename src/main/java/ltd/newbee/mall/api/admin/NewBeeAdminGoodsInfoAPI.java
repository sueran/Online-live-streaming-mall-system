...
//        System.out.println(goodsAddParam);
//        System.out.println(Integer.parseInt(adminUser.getAdminUserId().toString()));
        logger.info("adminUser:{}", adminUser.toString());
        NewBeeMallGoods newBeeMallGoods = new NewBeeMallGoods();
        newBeeMallGoods.setCreateUser(adminUser.getAdminUserId());
