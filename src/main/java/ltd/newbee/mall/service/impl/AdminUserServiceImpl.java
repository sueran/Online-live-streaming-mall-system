...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public String login(String userName, String password) {
        ...
        String id= loginAdminUser.getAdminUserId().toString();
    ...
    @Override
    public Long register(String nickName, String password, String loginUserPhone) {

        String passwordMD5 = MD5Util.MD5Encode(password, "UTF-8");

        AdminUser adminUser= new AdminUser();
        adminUser.setLoginUserName(loginUserPhone);
        adminUser.setNickName(nickName);
        adminUser.setLoginPassword(passwordMD5);
        Long ID= IdWorker.getId(adminUser);
    ...
    public Integer validatePhone(String phone) {
        ...
        int i = adminUserMapper.validatePhone(phone);
