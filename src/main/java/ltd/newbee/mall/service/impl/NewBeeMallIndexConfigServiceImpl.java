...
//            List<NewBeeMallIndexConfigGoodsVO> list= new ArrayList<>();
            for (NewBeeMallGoods item : newBeeMallGoods){
                NewBeeMallIndexConfigGoodsVO newBeeMallIndexConfigGoodsVOS1= new NewBeeMallIndexConfigGoodsVO();
                BeanUtil.copyProperties(item,newBeeMallIndexConfigGoodsVOS1);
                Shop shopInfoById = shopService.getShopInfoById(item.getCreateUser());
                if(!ObjectUtils.isEmpty(shopInfoById)){
                    newBeeMallIndexConfigGoodsVOS1.setShopId(shopInfoById.getId().toString());
                }else{
                    newBeeMallIndexConfigGoodsVOS1.setShopId(null);;
                }

                newBeeMallIndexConfigGoodsVOS.add(newBeeMallIndexConfigGoodsVOS1);
            }
