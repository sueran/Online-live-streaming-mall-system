...
//        int total = goodsMapper.getTotalNewBeeMallGoods(pageUtil);
    ...
    @Override
    public List<NewBeeMallGoods> getAllGoodsByOwnerId(Long id) {
      return   goodsMapper.getAllGoodsByOwnerId(id);
    }

    @Override
    public Integer updateTagById(NewBeeMallGoods goods) {
    ...
    @Override
    public Integer initUpdateTag(Long createId) {
        int i = goodsMapper.initTag(createId);
        return i;
    }
}
